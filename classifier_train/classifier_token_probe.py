...
class TokenProbeDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.hidden_state_dir:
            hidden_state = np.load(os.path.join(self.hidden_state_dir, f"hidden_states_{image_id}.npy"))
...
def save_model(model, model_name, epoch):
    save_dir = f'models/token_probe_infoseek_i2/{model_name}'
    ...
    for num_classes in [4, 2]:
        ...
        for layer_idx in layer_indices:
            ...
            dataset = TokenProbeDataset(
                ...
                json_file='data_0921/infoseek/infoseek_i2_rir/Qwen25_72B_Instruct_awq_vllm_l20_judged_logs_infoseek_i2_rir.json',
                image_hidden_state_dir='data_image_token_i2_train/data_image_token/hidden_state',
                original_image_hidden_state_dir='data_image_token_i2_train/data_image_token/original_hidden_state',
            ...
            model_configs = [
                # (4096 + 4096 = 8192)
                (f'qwen_dp3_{task_prefix}_layer_{layer_idx}_original_image_wo_rir', 8192, num_classes),
...
#  (False, False): 2333 sample
#  (False, True): 32 sample
#  (True, False): 141 sample
#  (True, True): 81 sample
