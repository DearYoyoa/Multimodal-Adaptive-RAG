...
def main(args):
    ...
    with open('data_1017/evqa/evqa_i2_test_rir/Qwen25_72B_Instruct_awq_vllm_l20_judged_logs_evqa_i2_test_rir.json', 'r') as f:
        logs_test_rir = json.load(f)
    
    with open('data_1017/evqa/evqa_i2_test/Qwen25_72B_Instruct_awq_vllm_l20_judged_logs_evqa_i2_test.json', 'r') as f:
    ...
    for idx, sample in tqdm(enumerate(samples[args.idx_offset:]), total=len(samples[args.idx_offset:])):
        ...
        last_hidden_rir = np.load(f"hidden_state_i2_test/hidden_evqa/last_hidden_state_rir/{sample['image_id']}.npy")
