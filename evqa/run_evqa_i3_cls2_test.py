...
def main(args):
    ...
    with open('data_1017/evqa_i3/evqa_test_i3_rir/Qwen25_72B_Instruct_awq_vllm_l20_judged_logs_evqa_test_i3_rir.json', 'r') as f:
        logs_test_rir = json.load(f)
    
    with open('data_1017/evqa_i3/evqa_test_i3/Qwen25_72B_Instruct_awq_vllm_l20_judged_logs_evqa_test_i3.json', 'r') as f:
    ...
    for idx, sample in tqdm(enumerate(samples[args.idx_offset:]), total=len(samples[args.idx_offset:])):
        ...
        last_hidden_rir = np.load(f"hidden_state_i3_test/hidden_evqa/last_hidden_state_rir/{sample['image_id']}.npy")
        last_hidden = np.load(f"hidden_state_i3_test/hidden_evqa/last_hidden_state/{sample['image_id']}.npy")
        image_hidden = np.load(f"hidden_state_i3_test/hidden_evqa/hidden_state/{sample['image_id']}.npy")
        original_hidden = np.load(f"hidden_state_i3_test/hidden_evqa/original_hidden_state/{sample['image_id']}.npy")
