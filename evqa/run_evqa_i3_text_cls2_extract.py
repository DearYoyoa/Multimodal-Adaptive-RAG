...
def query_with_image(
    ...
    if use_screenshot:
        ...
        if not os.path.exists(f'hidden_state_i3_test/hidden_evqa/last_hidden_state_rir'):
            os.makedirs(f'hidden_state_i3_test/hidden_evqa/last_hidden_state_rir')
        np.save(f'hidden_state_i3_test/hidden_evqa/last_hidden_state_rir/{image_path.split("/")[-1].split(".")[0]}.npy', hidden_state_with_screenshot)
    else:
        with torch.no_grad():
            model_output = model(
                **inputs,
        ...
        if not os.path.exists(f'hidden_state_i3_test/hidden_evqa/last_hidden_state'):
            os.makedirs(f'hidden_state_i3_test/hidden_evqa/last_hidden_state')
        np.save(f'hidden_state_i3_test/hidden_evqa/last_hidden_state/{image_path.split("/")[-1].split(".")[0]}.npy', hidden_state_without_screenshot)
    ...
    if extract_vision_feature:
        ...
        if not os.path.exists(f'hidden_state_i3_test/hidden_evqa/hidden_state/'):
            os.makedirs(f'hidden_state_i3_test/hidden_evqa/hidden_state/')
        np.save(f'hidden_state_i3_test/hidden_evqa/hidden_state/{image_path.split("/")[-1].split(".")[0]}.npy', vision_features)
        if not os.path.exists(f'hidden_state_i3_test/hidden_evqa/original_hidden_state/'):
            os.makedirs(f'hidden_state_i3_test/hidden_evqa/original_hidden_state/')
        np.save(f'hidden_state_i3_test/hidden_evqa/original_hidden_state/{image_path.split("/")[-1].split(".")[0]}.npy', original_vision_features.cpu().numpy())
    # 处理生成的文本
    # generated_ids = 0
