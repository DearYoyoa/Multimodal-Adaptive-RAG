...
def query_with_image(
    ...
    if extract_vision_feature:
        ...
        if not os.path.exists(f'hidden_state_qwen_test/hidden_infoseek_image_mean/hidden_state/'):
            os.makedirs(f'hidden_state_qwen_test/hidden_infoseek_image_mean/hidden_state/')
...
def main(args):
    ...
    for idx, sample in tqdm(enumerate(samples[args.idx_offset:]), total=len(samples[args.idx_offset:])):
        ...
        # print(f'Processing {idx}th sample: {sample["image_id"]}')
