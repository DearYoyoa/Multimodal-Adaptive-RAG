...
def query_with_image(
    ...
    if use_screenshot:
        ...
        exact_features = extract_exact_answer_features(model_output,query_text, inputs, model, processor, pred, model.name_or_path, ground_truth, generated_output_with_screenshot)

        for token_type, features in exact_features.items():
            save_dir = f'hidden_state_i2_train/hidden_infoseek/exact_answer_features_mlp_rir/{token_type}'
